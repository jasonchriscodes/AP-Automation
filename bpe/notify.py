...
class Notification:
    ...
    def __init__(self,mail_type,to_email,cc_email,user_name,pass_word):
    ...
    def no_lines_notify(self,po_num):
        ...
        ##m.close()
        self.add_to_digest( "no lines", po_num, str(po_num)+" <b>Missing lines: <br/>")
    ...
    def totals_did_not_match_notify(self, po_num,details_total,doc_total):
        ...
        ##m.sendHTMLMail(self.to_email,html)
        ##m.close()
        self.add_to_digest( "totals mismatch", po_num, str(po_num)+" <b>Total mismatch:</b> <b>Details Total:</b>"+str(details_total)+"<br/><b>Document Total:</b>"+str(doc_total)+"<br/>")
        self.set_Success_Fail(0,1)
    ...
    def publish_failed_notify(self, po_num):
        ...
        ##m.sendHTMLMail(self.to_email,html)
        ##m.close()
        self.add_to_digest( "publish failed", po_num, str(po_num)+" <b>failed.</b><br/>")
        self.set_Success_Fail(0,1)
    ...
    def publish_failed_notify_unknown_error(self, po_num,msg):
        ...
        ##m.sendHTMLMail(self.to_email,html)
        ##m.close()
        self.add_to_digest( "unknown error", po_num, str(po_num)+" <b>erred with message:</b> "+msg+".<br/>")
        self.set_Success_Fail(0,1)
    ...
    def outbox_Msgs1(self):
        ...
        if(self.digest_log):
            ...
            html += "Automation triggered at "+dt.strftime('%c')+" with the EOM cutoff set as "+self.EOM+".<br/><br/>"
            #html += "A total of "+str(self.totalPOs)+" were looked into and following POs has problems.<br/><br/>"
            html +=  str(self.totalPOs)+" invoices processed from Ferret via AP Automation<br/><br/>"
            html += str(self.allGood)+" processed are OK with no issues.<br/><br/>"
            html +=  "But "+str(self.monkeyWrench)+" of the following issues were encountered <br/><br/>"
